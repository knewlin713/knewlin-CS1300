  ...
  return (
    <>
      <div>
        ...
        <div class="content" style={{ backgroundColor: "#fff5e6" }}>
        ...
        <div class="content">
          ...
          <h2 style={{ color: "#3C1518", paddingTop: "100px" }} alt="bad flow chart"> Original Flow State: Mouse</h2>
          <img src="src/assets/Flow Chart Template (Copy).png" ></img>
          <h2 style={{ color: "#3C1518", paddingTop: "100px" }} alt="bad flow chart"> Original Flow State: Keyboard</h2>
          <img src="src/assets/Flow Chart Template (Copy)-2.png" ></img>
          <h2 style={{ color: "#3C1518", paddingTop: "100px" }} alt="good flow chart"> Redesigned Flow State: Mouse</h2>
          <img src="src/assets/Flow Chart Template (Copy)-3.png" ></img>
          <h2 style={{ color: "#3C1518", paddingTop: "100px" }} alt="good flow chart"> Redesigned Flow State: Keyboard</h2>
          <img src="src/assets/Flow Chart Template (Copy) copy.png" ></img>
